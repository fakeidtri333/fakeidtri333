...
#define ddr_set(bit) (_SFR_BYTE(DDRB) = _SFR_BYTE(DDRB) | _BV(bit))
#define ddr_clr(bit) (_SFR_BYTE(DDRB) = _SFR_BYTE(DDRB) & ~_BV(bit))
#define bit_set(bit) (_SFR_BYTE( B) = _SFR_BYTE( B) | _BV(bit))
#define bit_clr(bit) (_SFR_BYTE( B) = _SFR_BYTE( B) & ~_BV(bit))
#define bit_read(bit) (_SFR_BYTE(PINB) & _BV(bit))
#define DS_RST 2 // DS1620 reset
#define DS_CLK 1 // DS1620 clock
#define DS_DATA 0 // DS1620 data
//------------------ local prototypes -----------------------------------------
